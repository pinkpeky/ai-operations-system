...
```text
codex/phase-62a-comfyui-runtime-adapter-contract
```
...
- A ComfyUI Runtime Adapter Contract page that lets a server maintainer inspect provider, enabled switch, base URL, timeout, allowlist, required configuration, and disabled actions without making a network request or enabling a live adapter.
