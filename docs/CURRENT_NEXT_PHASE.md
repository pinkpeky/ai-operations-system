...
1. Finish the Phase 62E ComfyUI runtime maintenance runbook backend/API/frontend/docs slice.
2. Run backend, frontend, docs, migration, and browser verification gates.
3. Keep PR #70 as the Phase 62D draft and open/update the Phase 62E stacked draft PR from `codex/phase-62e-comfyui-maintenance-console` when verification passes.
