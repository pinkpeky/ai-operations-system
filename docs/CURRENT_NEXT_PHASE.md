...
9. Track draft PR #90 for Phase 62X Customer Console Product Operation Desk and verify ordinary customer-machine users can start from a product/campaign topic, see process, deliverables, interrupt/continue controls, and upload knowledge without using server-maintenance screens.
