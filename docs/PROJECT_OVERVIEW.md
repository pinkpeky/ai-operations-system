...
The current next branch is `codex/phase-61q-commercial-comfyui-handoffs`, scoped to Phase 61Q Commercial Operation ComfyUI Handoffs: `commercial_operation_comfyui_handoffs`, `/api/v1/commercial-operations/{operation_id}/comfyui-handoffs`, a Commercial Ops ComfyUI handoff panel, prompt/workflow payloads, readiness checks, and lifecycle decisions for approved/prepared asset requests before any real ComfyUI generation.
