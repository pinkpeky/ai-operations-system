...
The current next branch is `codex/phase-60-workflow-observability-simplification`, scoped to Replay Center command-center guidance, localized workflow observability labels, attention metrics, trace filtering, and clearer replay boundaries without changing execution semantics.
