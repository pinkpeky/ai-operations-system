...
The current next branch is `codex/phase-61r-commercial-comfyui-preflight`, scoped to Phase 61R Commercial Operation ComfyUI Preflights: `commercial_operation_comfyui_preflights`, `/api/v1/commercial-operations/{operation_id}/comfyui-preflights`, a Commercial Ops ComfyUI preflight panel, endpoint/queue/model/workflow readiness checks, and guarded adapter config normalization for approved/prepared handoffs before any real ComfyUI connection or generation.
