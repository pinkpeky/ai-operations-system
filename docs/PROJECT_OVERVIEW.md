...
The current next branch is `codex/phase-61g-commercial-operation-deliverables`, scoped to Phase 61G Commercial Operation Deliverables: `commercial_operation_deliverables`, `/api/v1/commercial-operations/{operation_id}/deliverables`, a Commercial Ops Deliverables panel, linked Output Library artifacts with `source_type=commercial_operation`, and explicit create/update/ready/approve/reject/package/fail/archive records for commercial handoff packages.
