...
- Commercial Operation Evidence Snapshots with `commercial_operation_evidence_snapshots`, create/list/update/ready/approve/reject/archive APIs, execution request/run evidence snapshot IDs, operator checklists, and Admin Dashboard controls for reviewed knowledge/source evidence without live RAG retrieval, knowledge ingestion, publishing, or external execution.
