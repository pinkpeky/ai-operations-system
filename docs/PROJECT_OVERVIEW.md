...
The current next branch is `codex/phase-59-run-cockpit-search-density`, scoped to Run Cockpit search, filtered density counters, and operator scan ergonomics across threads, task runs, playbook runs, and output artifacts.
