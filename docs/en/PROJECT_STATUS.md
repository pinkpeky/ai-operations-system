...
Current update (2026-05-20): Phase 57A-59C, Phase 60A-60G, and Phase 61A-61P have landed on `main` through PR #22-#56. PR #57 is the draft Phase 61Q ComfyUI handoff slice, PR #58 is the draft Phase 61R ComfyUI preflight slice, and PR #59 is the draft Phase 61S ComfyUI adapter config slice. The active next branch is `codex/phase-61t-commercial-comfyui-job-requests`, scoped to Phase 61T Commercial Operation ComfyUI Job Requests: `/api/v1/commercial-operations/{operation_id}/comfyui-job-requests`, Admin Dashboard ComfyUI job request controls, checked-preflight-to-job-request review lifecycle, safety checks, output expectations, and recovery guidance before any real ComfyUI connection, file upload, queue submission, or generation.
