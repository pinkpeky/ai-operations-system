...
Current update (2026-05-21): Phase 57A-59C, Phase 60A-60G, and Phase 61A-61P have landed on `main` through PR #22-#56. PR #57 is the draft Phase 61Q ComfyUI handoff slice, PR #58 is the draft Phase 61R ComfyUI preflight slice, PR #59 is the draft Phase 61S ComfyUI adapter config slice, and PR #60 is the draft Phase 61T ComfyUI job request slice. The active next branch is `codex/phase-61u-commercial-comfyui-execution-plans`, scoped to Phase 61U Commercial Operation ComfyUI Execution Plans: `/api/v1/commercial-operations/{operation_id}/comfyui-execution-plans`, Admin Dashboard ComfyUI execution plan controls, approved/queued-job-request-to-execution-plan review lifecycle, queue simulation payload normalization, operator checklist, and rollback guidance before any real ComfyUI connection, file upload, queue submission, or generation.
