...
Phase 62A adds a disabled-by-default ComfyUI runtime adapter contract with provider, switch, base URL, timeout, allowlist, disabled action, required configuration, and guardrail visibility before any live adapter call exists.
