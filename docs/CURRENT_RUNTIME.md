...
| `DIGITAL_HUMAN_PROVIDER` | `mock` | Digital human provider selector. Current Phase 67B behavior supports local delivery manifests and guarded ComfyUI handoff while external provider calls remain disabled by default. |
