...
| `DIGITAL_HUMAN_PROVIDER` | `mock` | Digital human provider selector. Current Phase 67A behavior is plan-only/mock unless future explicit provider gates are added. |
