...
`main` is the active accepted baseline branch after Phase 56A-56D readiness closures, Phase 57A-59C Run Cockpit product slices, Phase 60A-60G frontend/RAG validation slices, Phase 61A Commercial Operations Foundation, Phase 61B Commercial Operation Evidence & Handoff Links, Phase 61C Commercial Operation Approval Gates, Phase 61D Commercial Operation Safe Dry-Runs, Phase 61E Commercial Operation Content Drafts, Phase 61F Commercial Operation Asset Requests, Phase 61G Commercial Operation Deliverables, Phase 61H Commercial Operation Execution Requests, Phase 61I Commercial Operation Execution Runs, Phase 61J Commercial Operation Results, Phase 61K Commercial Operation Monitoring Observations, and Phase 61L Commercial Operation Optimization Decisions.

Current effective phase: Phase 61M Commercial Operation Evidence Snapshots. Phase 56 was reverted and is not active. The old reverted Phase 56 branch is not active, not part of the accepted baseline, and should not be reused.

The current fresh branch is `codex/phase-61m-commercial-evidence-snapshots`. It follows merged PR #52 and adds commercial operation evidence snapshot records: `commercial_operation_evidence_snapshots`, evidence snapshot create/list/update/ready/approve/reject/archive APIs, execution request/run evidence snapshot IDs, operator checklists, and a bilingual Admin Dashboard surface for packaging approved knowledge evidence without live RAG retrieval, knowledge ingestion, publishing, or external execution.
