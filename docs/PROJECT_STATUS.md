...
`codex/phase-59-run-cockpit-search-density` is the active next branch. It adds Run Cockpit search, filtered density counters, and scan ergonomics across threads, task runs, playbook runs, and output artifacts. It does not reuse the reverted Phase 56 branch.
