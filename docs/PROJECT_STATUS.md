...
`codex/phase-60-conversation-operator-simplification` is the active next branch. It adds a Chinese-first Conversations command summary, localized create/send/run controls, run-mode guidance, summary cards for messages/approvals/artifacts, and clearer section labels. It does not reuse the reverted Phase 56 branch.
