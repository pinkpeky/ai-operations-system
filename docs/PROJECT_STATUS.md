...
`codex/phase-60-rag-operations-ui` is the active next branch. It adds RAG upload, text ingest, document detail, reingest, delete confirmation, retrieval debug, and operator result feedback. It does not reuse the reverted Phase 56 branch.
