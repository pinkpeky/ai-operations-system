...
`codex/phase-60-workflow-observability-simplification` is the active next branch. It adds Replay Center command-center guidance, localized workflow observability labels, attention metrics, trace filtering, and clearer replay boundaries. It does not reuse the reverted Phase 56 branch.
