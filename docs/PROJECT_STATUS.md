...
`codex/phase-60g-closeout-61a-operations-foundation` is the active next branch. It adds the Phase 61A Commercial Operations Foundation: workspace-scoped commercial operation records, `/api/v1/commercial-operations`, an Admin Dashboard Commercial Ops page, and a conservative plan draft that does not publish, execute external actions, or bypass approval.
