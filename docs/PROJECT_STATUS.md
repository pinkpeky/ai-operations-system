...
`codex/phase-60-rag-live-validation` is the active next branch. It validates the live RAG upload/search/debug/reingest/delete loop, adds concise RAG operator guidance, and documents workstation/server-maintainer procedures. It does not reuse the reverted Phase 56 branch.
