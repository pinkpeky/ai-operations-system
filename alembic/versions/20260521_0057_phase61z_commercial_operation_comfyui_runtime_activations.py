...
Revision ID: 0057_phase61z_comfyui_active
Revises: 0056_phase61y_comfyui_dryruns
...
revision = "0057_phase61z_comfyui_active"
down_revision = "0056_phase61y_comfyui_dryruns"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("runtime_dry_run_id", sa.Uuid(), nullable=False),
        ...
        sa.Column("activation_status", sa.String(length=32), nullable=False, server_default="draft"),
        sa.Column("activation_mode", sa.String(length=32), nullable=False, server_default="metadata_only"),
        ...
        sa.Column("server_switch_name", sa.String(length=128), nullable=False, server_default="COMFYUI_RUNTIME_ENABLED"),
        sa.Column("activation_request", sa.JSON(), nullable=False, server_default=_json_default("{}")),
        sa.Column("switch_audit", sa.JSON(), nullable=False, server_default=_json_default("{}")),
        sa.Column("runtime_guardrails", sa.JSON(), nullable=False, server_default=_json_default("{}")),
        ...
        sa.Column("activation_payload", sa.JSON(), nullable=False, server_default=_json_default("{}")),
        ...
        sa.Column("scheduled_by", sa.String(length=128), nullable=True),
        ...
        sa.ForeignKeyConstraint(["runtime_dry_run_id"], ["commercial_operation_comfyui_runtime_dry_runs.id"], ondelete="RESTRICT"),
    ...
    for column in (
        ...
        op.create_index(
            f"ix_commercial_op_comfyui_activations_{column}",
            "commercial_operation_comfyui_runtime_activations",
            [column],
        )
...
def downgrade() -> None:
    op.drop_table("commercial_operation_comfyui_runtime_activations")
