...
Revision ID: 0040_phase61f_asset_requests
Revises: 0039_phase61e_content_drafts
...
revision = "0040_phase61f_asset_requests"
down_revision = "0039_phase61e_content_drafts"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    for column in (
        ...
        op.create_index(
            f"ix_commercial_operation_asset_requests_{column}",
            "commercial_operation_asset_requests",
            [column],
        )
...
def downgrade() -> None:
    op.drop_table("commercial_operation_asset_requests")
