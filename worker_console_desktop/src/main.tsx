...
function ChatPanel({
      ...
      const updatedRun = await commercialOperationClient.updateExecutionRun(
        ...
        targetRun.id,
        {
          input_payload: {
            ...
            source: "worker_console_desktop_client_runtime_preflight",
            console: "worker_console_desktop",
            cycle,
    ...
    try {
      ...
      const updatedRun = await commercialOperationClient.updateExecutionRun(
        ...
        targetRun.id,
        {
          input_payload: {
            ...targetRun.input_payload,
            source: "worker_console_desktop_guarded_adapter_dispatch_handoff",
            console: "worker_console_desktop",
            previous_source: previousSource,
            cycle,
      ...
      if (!handoffReady) {
        const blockedRun = await commercialOperationClient.updateExecutionRun(
          ...
          targetRun.id,
          {
            input_payload: {
              ...targetRun.input_payload,
              source: "worker_console_desktop_guarded_adapter_dry_run",
              previous_source: previousSource,
              cycle,
  ...
  const completeCommercialResultFeedbackLoop = async () => {
    ...
    try {
      ...
      const feedbackSource = runIsNextCycle ? "worker_console_desktop_next_cycle_result_feedback_loop" : "worker_console_result_feedback_loop";
  ...
  return (
    <main className="app-shell min-h-screen">
      ...
      {operatorPage === "knowledge" ? (
        ...
        <ChatPanel language={language} onOpenKnowledge={() => setOperatorPage("knowledge")} runtimeClient={client} />
      )}
