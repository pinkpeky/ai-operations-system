...
class CommercialOperationComfyUIPreflightStatus(StrEnum):
    """Commercial operation ComfyUI preflight lifecycle status."""
...
class CommercialOperationComfyUIJobRequestStatus(StrEnum):
    """Commercial operation ComfyUI job request lifecycle status."""
...
class CommercialOperationComfyUIConnectionProbeStatus(StrEnum):
    """Commercial operation ComfyUI connection probe lifecycle status."""
...
class CommercialOperationComfyUIRuntimeDryRunStatus(StrEnum):
    """Commercial operation ComfyUI runtime dry-run lifecycle status."""
...
class CommercialOperationMonitoringObservationStatus(StrEnum):
    """Commercial operation monitoring observation lifecycle status."""
