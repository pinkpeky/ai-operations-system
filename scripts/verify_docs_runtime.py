...
class DocsRuntimeVerifier:
    ...
    def check_runtime_config(self) -> None:
        ...
        expected_values = {
            ...
            "COMFYUI_RUNTIME_PROVIDER": settings.comfyui_runtime_provider,
            "COMFYUI_RUNTIME_ENABLED": str(settings.comfyui_runtime_enabled),
            "COMFYUI_RUNTIME_BASE_URL": settings.comfyui_runtime_base_url,
            "COMFYUI_RUNTIME_TIMEOUT_SECONDS": str(settings.comfyui_runtime_timeout_seconds),
            "COMFYUI_RUNTIME_ALLOW_NETWORK": str(settings.comfyui_runtime_allow_network),
            "COMFYUI_RUNTIME_ALLOWED_HOSTS": settings.comfyui_runtime_allowed_hosts,
            "COMFYUI_RUNTIME_READ_ONLY_PROBE_ENABLED": str(settings.comfyui_runtime_read_only_probe_enabled),
            "COMFYUI_RUNTIME_HEALTH_PATH": settings.comfyui_runtime_health_path,
            "COMFYUI_RUNTIME_ALLOWED_HEALTH_PATHS": settings.comfyui_runtime_allowed_health_paths,
            "COMFYUI_RUNTIME_PROMPT_SUBMISSION_ENABLED": str(settings.comfyui_runtime_prompt_submission_enabled),
            "COMFYUI_RUNTIME_ALLOWED_EXECUTION_PATHS": settings.comfyui_runtime_allowed_execution_paths,
            "COMFYUI_VIDEO_MAX_CONCURRENT_JOBS": str(settings.comfyui_video_max_concurrent_jobs),
            "COMFYUI_VIDEO_QUEUE_PENDING_LIMIT": str(settings.comfyui_video_queue_pending_limit),
            "COMFYUI_VIDEO_MIN_FREE_VRAM_MB": str(settings.comfyui_video_min_free_vram_mb),
            "COMFYUI_VIDEO_DEFAULT_VRAM_ESTIMATE_MB": str(settings.comfyui_video_default_vram_estimate_mb),
            "COMFYUI_VIDEO_GPU_ENDPOINTS": settings.comfyui_video_gpu_endpoints,
            "DIGITAL_HUMAN_PROVIDER": settings.digital_human_provider,
            "DIGITAL_HUMAN_ENABLED": str(settings.digital_human_enabled),
            "DIGITAL_HUMAN_ALLOW_EXTERNAL_API": str(settings.digital_human_allow_external_api),
            "DIGITAL_HUMAN_ASSET_DIR": settings.digital_human_asset_dir,
            "DIGITAL_HUMAN_OUTPUT_DIR": settings.digital_human_output_dir,
            "DIGITAL_HUMAN_DEFAULT_VOICE_ID": settings.digital_human_default_voice_id,
            "DIGITAL_HUMAN_DEFAULT_ASPECT_RATIO": settings.digital_human_default_aspect_ratio,
    ...
    def check_openapi_and_api_docs(self) -> None:
        ...
        required_paths = [
            ...
            "/api/v1/digital-humans/workflow-templates",
